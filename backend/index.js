...
const corsOptions = {
    origin: [
        ...
        "http://localhost:5174",
        "http://13.235.200.66:8000",  // Replace with actual EC2 public IP
...
// 🔹 Routes
app.use("/api/v1/user", userRoute);
app.use("/api/v1/post", postRoute);  // Protected Route
app.use("/api/v1/message", messageRoute);  // Protected Route
